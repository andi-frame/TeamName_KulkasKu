          ...
          {showPopup && (
            <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2">
              <div className="flex items-center gap-6">
                <Link href="/add-item" className="flex items-center gap-2 bg-white shadow-lg rounded-full p-2">
                ...
                <Link href="/add-food" className="flex items-center gap-2 bg-white shadow-lg rounded-full p-2">
                  <div className="w-12 h-12 flex items-center justify-center hover:bg-gray-50">
